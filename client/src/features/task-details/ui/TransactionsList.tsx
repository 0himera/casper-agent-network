...
const TX_LABELS: Record<string, string> = { create: "Create TX", assign: "Assign TX", submit: "Submit TX", complete: "Complete TX" };

interface TransactionsListProps { hashes: Record<string, string | undefined> }

...
export function NetworkMetrics() {
  return (
    <section id="metrics" className="grid grid-cols-1 lg:grid-cols-12 border-b border-brand-black bg-brand-bg text-brand-black">
      ...
      <div className="lg:col-span-11 px-6 py-20 md:px-12 lg:px-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div className="max-w-2xl text-brand-black">

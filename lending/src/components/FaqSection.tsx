...
export function FaqSection() {
  return (
    <section id="faq" className="grid grid-cols-1 lg:grid-cols-12 border-b border-brand-bg bg-brand-black text-brand-bg">
      ...
      <div className="lg:col-span-11 px-6 py-20 md:px-12 lg:px-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 select-none">
            ...
            <p className="font-sans text-base text-brand-bg/75 max-w-xl mx-auto">
